...
from kairix_engine.tts.elevenlabs_tts import ElevenLabsTTS
...
class TestElevenLabsTTS:
    ...
    @patch("kairix_engine.tts.elevenlabs_tts.ElevenLabs")
    ...
    @patch("kairix_engine.tts.elevenlabs_tts.ElevenLabs")
    def test_stream_tts_sync_error_handling(
        self, mock_elevenlabs_class, tts_instance
    ):
    ...
    @pytest.mark.asyncio
    @patch("kairix_engine.tts.elevenlabs_tts.AsyncElevenLabs")
    ...
    @patch("kairix_engine.tts.elevenlabs_tts.logger")
    @patch("kairix_engine.tts.elevenlabs_tts.ElevenLabs")
