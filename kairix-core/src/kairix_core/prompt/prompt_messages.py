self_reflective_summary = """
Now, as the AI assistant who shared this experience with Mark, create your reflective summary. 
Below is a conversation between Mark and yourself.
