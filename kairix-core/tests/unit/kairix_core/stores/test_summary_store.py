...
class TestDefaultStoreDB:
    ...
    @patch("kairix_core.cognition.stores.summary_store.db")
    @patch("kairix_core.cognition.stores.summary_store.neomodel_config")
    ...
    def test_cypher_query(self, mock_db):
        ...
        mock_db.cypher_query.assert_called_once_with("MATCH (n) RETURN n", {"param": "value"})
...
class TestSummaryStoreInitialization:
    ...
    @patch("kairix_core.cognition.stores.summary_store.SentenceTransformer")
    @patch("kairix_core.cognition.stores.summary_store.DefaultStoreDB")
...
class TestSummaryStoreFunctionality:
    ...
    @patch("kairix_core.cognition.stores.summary_store.logger")
