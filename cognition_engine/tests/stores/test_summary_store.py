...
from cognition_engine.stores.summary_store import (
...
def summary_store(mock_store, mock_transformer):
    ...
    with patch("cognition_engine.stores.summary_store.SentenceTransformer") as mock_st:
...
class TestDefaultStoreDB:
    ...
    @patch("cognition_engine.stores.summary_store.db")
    @patch("cognition_engine.stores.summary_store.neomodel_config")
...
class TestSummaryStoreInitialization:
    ...
    @patch("cognition_engine.stores.summary_store.SentenceTransformer")
    ...
    @patch("cognition_engine.stores.summary_store.SentenceTransformer")
    @patch("cognition_engine.stores.summary_store.DefaultStoreDB")
...
class TestSummaryStoreFunctionality:
    ...
    @patch("cognition_engine.stores.summary_store.logger")
...
class TestCypherQuery:
    ...
    def test_cypher_query_format(self):
        ...
        from cognition_engine.stores.summary_store import CYPHER_QUERY
