...
class TestSynthesisTabBasic(MemoryPipelineUITest):
    ...
    def test_synthesis_input_fields(self, ui_page: Page):
        ...
        # Verify default values (not placeholders in this UI)
        assert agent_input.input_value() == "Agent Name"
        assert run_id_input.input_value() == "Run ID"
        ...
        # (Can't verify placeholder since they don't have placeholders)
